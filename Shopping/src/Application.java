...
public class Application {
    ...
    public static void optionAddItemToCart() {
        try {
            ...
            shoppingCart.add(cartElement); // adiciono um novo item
            BubbleSort.sort(shoppingCart); // ordeno a lista na inserção deste item
        ...
        try {
            ...
            for (var itemInCart : shoppingCart) {
                ...
                if (itemInCart.getQuantity() > 0) {
                    if (itemInCart.getItem() instanceof FoodItem foodItem)
                        itemsRemaining
                                .add(new CartElement(foodItem, itemInCart.getPriority(), itemInCart.getQuantity()));
                    else if (itemInCart.getItem() instanceof ClothingItem clothingItem)
                        itemsRemaining
                                .add(new CartElement(clothingItem, itemInCart.getPriority(), itemInCart.getQuantity()));
                    else if (itemInCart.getItem() instanceof CleaningSuppliesItem cleaningSuppliesItem)
                        itemsRemaining.add(new CartElement(cleaningSuppliesItem, itemInCart.getPriority(),
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            if (option == 1) {
                ...
                ItemsIO.write(itemsRemaining, "items_remaining");
            }
